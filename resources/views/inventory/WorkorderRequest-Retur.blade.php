...
<head>
    <meta charset="UTF-8">
    <title>Retur Pemakaian Bangkel {{$header[0]->doc_number ?? ''}}</title>
...
<div class="header"><strong>RETUR PENGELUARAN BENGKEL/SERVICE</strong></div>
	...
	<table class="tb-row">
		<thead>
			<tr>
				...
				<th width="60px">Dikeluarkan</th>
				<th width="80px">Satuan</th>
				<th width="60px">Retur</th>
			</tr>
		</thead>
		<tbody>
    	    @php $amount=0; @endphp
