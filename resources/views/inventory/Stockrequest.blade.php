...
<div clas="header">PERMINTAAN STOK BARANG</div>
...
<div class="invoice" style="margin-left:0px">
	<table class="tb-row">
		...
		<tbody>
		    ...
		    <tr  style="text-align:left;vertical-align:top">
				...
				<td align="right">{{number_format($line->qty_stock,0,',','.')}}</td>
			</tr>
			@php
	...
	<table class="tb-row">
		<tr style="text-align:center;vertical-align:center;font-weight:bold">
			...
			<td width="150px">Diberikan oleh</td>
		</tr>
